...
class _VehicleFilterWidgetState extends State<VehicleFilterWidget> {
  ...
  int digitAfterDecimal =
      Get.find<SplashController>().configModel!.digitAfterDecimalPoint ?? 0;
  ...
  void initState() {
    ...
    if (Get.find<TaxiVendorController>().maxPrice == 0 ||
        Get.find<TaxiVendorController>().minPrice == 0) {
      Get.find<TaxiVendorController>().setMinAndMaxPrice(
          widget.minPrice ?? 0, widget.maxPrice ?? 1000,
          willUpdate: false);
    }
    if (Get.find<TaxiHomeController>().maxPrice == 0 ||
        Get.find<TaxiHomeController>().minPrice == 0) {
      Get.find<TaxiHomeController>().setMinAndMaxPrice(
          widget.minPrice ?? 0, widget.maxPrice ?? 1000,
          willUpdate: false);
    }
                      ...
                      child: Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  RichText(
                                    ...
                                    TextSpan(
                                        text: taxiHomeController.minPrice >
                                                100000
                                            ...
                                            : PriceConverter.convertPrice(
                                                taxiHomeController.minPrice),
                                        style: robotoRegular.copyWith(
                                            color: Colors.black, fontSize: 14)),
                                    TextSpan(
                                        text:
                                            '/${widget.tripType == 'hourly' ? 'hr'.tr : 'km'.tr}',
                                        style: robotoRegular.copyWith(
                                  ...
                                  RichText(
                                      text: TextSpan(children: <TextSpan>[
                                    TextSpan(
                                        text: taxiHomeController.maxPrice >
                                                100000
                                            ? PriceConverter.convertPrice(0,
                                                formatedStringPrice:
                                                    NumberFormat.compact()
                            ...
                            RangeSlider(
                              values: RangeValues(
                                  fromVendor
                                      ? taxiVendorController.minPrice
                                      : taxiHomeController.minPrice,
                                  fromVendor
                                      ? taxiVendorController.maxPrice
                                      : taxiHomeController.maxPrice),
                              ...
                              onChanged: (RangeValues rangeValues) {
                                if (fromVendor) {
                                  taxiVendorController.setMinAndMaxPrice(
                                      rangeValues.start, rangeValues.end);
                                } else {
                                  taxiHomeController.setMinAndMaxPrice(
                                      rangeValues.start, rangeValues.end);
                                }
                              },
                            ),
                            ...
                            taxiHomeController.taxiBrandModel != null &&
                                    taxiHomeController.taxiBrandModel!.brands !=
                                        null
                                ? Column(
                                    crossAxisAlignment:
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemCount: taxiHomeController
                                                ...
                                                .length,
                                            itemBuilder: (context, index) {
                                              int id = taxiHomeController
                                                  .vehicleCategoryModel!
                                                  .vehicles![index]
                                                  .id!;
                                              bool selected = taxiHomeController
                                                  .selectedCategoryIds
                                                  .contains(id);
                                              String name =
                                                  StringLimitHelper.limitText(
                                                      taxiHomeController
                                                              .vehicleCategoryModel!
                                                              .vehicles![index]
                                                              .name ??
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  bool selected = false;
                                  String seat =
                                      jsonEncode(AppConstants.seats[index]);
                                  if (AppConstants.seats[index] == '14+') {
                                    seat = jsonEncode('14-1000');
                                  }
                                  if (fromVendor) {
                                    selected = taxiVendorController
                                  ...
                                  return Padding(
                                    ...
                                    child: CustomInkWell(
                                      onTap: () {
                                        if (fromVendor) {
                                          taxiVendorController
                                              .addOrRemoveSeatingCapacity(seat);
                                        } else {
                                          taxiHomeController
                                              .addOrRemoveSeatingCapacity(seat);
                                        }
                                        ...
                                        Container(
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                                ...
                                                width: selected ? 0.7 : 0.2),
                                          ),
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 15, vertical: 5),
                                          child: Text(
                                              '${AppConstants.seats[index]} ${'seats'.tr}',
                                              style: robotoRegular.copyWith(
                                                  fontSize: 12,
                                                  fontWeight: selected
                                                      ? FontWeight.bold
                            ...
                            Row(children: [
                              Stack(children: [
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: Colors.grey.shade400,
                                        width: taxiHomeController.airCondition
                                            ? 0.7
                                            : 0.2),
                                  ),
                                  child: CustomInkWell(
                                    ...
                                    child: Text(
                                      ...
                                      style: robotoRegular.copyWith(
                                          ...
                                          fontWeight:
                                              taxiHomeController.airCondition
                                                  ? FontWeight.bold
                                                  : FontWeight.normal),
                                    ),
                                  ),
                                ...
                                if (fromVendor
                                    ? taxiVendorController.airCondition
                                    : taxiHomeController.airCondition)
                                  Positioned(
                                    right: 0.1,
                                    top: 0.1,
                              ...
                              Stack(children: [
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: Colors.grey.shade400,
                                        width:
                                            taxiHomeController.nonAirCondition
                                                ? 0.7
                                                : 0.2),
                                  ),
                                  child: CustomInkWell(
                                ...
                                if (fromVendor
                                    ? taxiVendorController.nonAirCondition
                                    : taxiHomeController.nonAirCondition)
                                  Positioned(
                                    right: 0.1,
                                    top: 0.1,
                    ...
                    onPressed: () {
                      if (fromVendor) {
                        Get.find<TaxiVendorController>()
                            .initFilterSetup(maxPrice: widget.maxPrice);
                        Get.find<TaxiVendorController>().getVendorVehicleList(
                            offset: 1,
                            vendorId: widget.vendorId!,
                            searchName: widget.searchCarName);
                      } else {
                        Get.find<TaxiHomeController>()
                            .resetFilter(widget.maxPrice);
                        Get.find<TaxiHomeController>().getSelectedCars(
                            offset: 1,
                            name: widget.searchCarName,
                            reload: true);
                      }
                      Get.back();
                    },
