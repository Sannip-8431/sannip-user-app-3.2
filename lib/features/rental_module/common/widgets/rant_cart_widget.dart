...
class RantCartWidget extends StatelessWidget {
  ...
  const RantCartWidget(
      {super.key, this.fromSelectVehicleScreen = false, this.callback});

  @override
  Widget build(BuildContext context) {
    return CustomInkWell(
      onTap: () => Get.to(() =>
              TaxiCartScreen(fromSelectVehicleScreen: fromSelectVehicleScreen))!
          .then((value) {
        callback!(true);
      }),
      radius: 50,
          ...
          taxiCartController.cartList.isNotEmpty
              ? Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text("${taxiCartController.cartList.length}",
