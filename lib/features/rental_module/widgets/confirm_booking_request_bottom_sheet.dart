...
class ConfirmBookingRequestBottomSheet extends StatelessWidget {
  ...
  const ConfirmBookingRequestBottomSheet(
      {super.key, required this.isScheduleBooking, required this.isBooking});
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Text(
              isBooking
                  ? 'booking_request_successful'.tr
                  : 'schedule_booking_request_successful'.tr,
              style: robotoBold),
        ),
        Padding(
          ...
          child: isBooking
              ? Text(
                  '${'your_vehicle_will_arrive_soon'.tr}\n${'to_know_other_info'.tr}',
                  style: robotoRegular.copyWith(fontSize: 12),
                  textAlign: TextAlign.center,
                )
              : Text(
                  'Your request has been submitted successfully. your preferable Vehicle will be arrived on time after confirmation.\n\n'
        ...
        SafeArea(
          child: Padding(
            padding: EdgeInsets.only(
                bottom:
                    GetPlatform.isAndroid ? Dimensions.paddingSizeSmall : 0),
            child: CustomButton(
              buttonText: 'okay'.tr,
              width: 150,
              height: 40,
