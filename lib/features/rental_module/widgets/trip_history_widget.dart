...
class TripHistoryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TaxiOrderController>(builder: (taxiOrderController) {
      return taxiOrderController.tripHistoryModel != null &&
              taxiOrderController.tripHistoryModel!.trips != null
          ? taxiOrderController.tripHistoryModel!.trips!.isNotEmpty
              ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ListView.builder(
                    ...
                    itemCount:
                        taxiOrderController.tripHistoryModel!.trips!.length > 5
                            ? 5
                            : taxiOrderController
                                .tripHistoryModel!.trips!.length,
                    itemBuilder: (context, index) {
                      return TripHistoryCard(
                          trip: taxiOrderController
                              .tripHistoryModel!.trips![index]);
                    },
                  )
                ])
              : const SizedBox()
          : const TopHistoryWidgetShimmerView();
    });
  }
}
