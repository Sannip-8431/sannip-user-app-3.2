...
class TripFromToCard extends StatelessWidget {
  ...
  const TripFromToCard(
      {super.key,
      required this.fromAddress,
      required this.toAddress,
      this.showTitle = false,
      this.searchName,
      this.fromCartOnClick});
                        ...
                        onTap: () {
                          Get.bottomSheet(
                            Container(
                              ...
                              child: TaxiLocationResultBottomSheet(
            ...
            child: Row(children: [
              Expanded(
                child: Column(
                    ...
                    children: [
                      if (fromAddress.addressType != null &&
                          fromAddress.addressType!.isNotEmpty)
                        Text(fromAddress.addressType?.tr ?? 'other'.tr,
                      ...
                      Text(
                        ...
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions
                              .fontSizeSmall, /* color: Theme.of(context).disabledColor*/
                        ),
                      ),
                    ]),
              ),
              fromCartOnClick != null
                  ? Padding(
                      padding: const EdgeInsets.only(
        ...
        Row(children: [
          ...
          Expanded(
            child:
              ...
              if (toAddress.addressType != null &&
                  toAddress.addressType!.isNotEmpty)
                Text(toAddress.addressType?.tr ?? 'other'.tr,
                    style: robotoMedium.copyWith(
                        fontSize: Dimensions.fontSizeDefault)),
              Text(
                toAddress.address ?? '',
