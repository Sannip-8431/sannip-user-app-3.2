...
class _ReviewBottomSheetState extends State<ReviewBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return Container(
      constraints: BoxConstraints(
          maxHeight: MediaQuery.of(context).size.height * 0.8, minHeight: 100),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Padding(
                ...
                child: Text('give_us_your_valuable_review'.tr,
                      ...
                      child: Column(children: [
                        ...
                        ClipRRect(
                          ...
                          child: CustomImage(
                            ...
                            fit: BoxFit.cover,
                            image:
                                formatedVehicleList[index].vehicleThumbnail ??
                                    '',
                          ),
                        ),
                        ...
                        Text(
                            '${'license_no'.tr}: ${formatedVehicleList[index].licensePlateNumber}',
                            style: robotoRegular.copyWith(
                                fontSize: Dimensions.fontSizeSmall,
                                color: Theme.of(context)
                                    .textTheme
            ...
            child: Padding(
              ...
              child: Column(children: [
                GetBuilder<TaxiOrderController>(builder: (taxiOrderController) {
                  return CustomButton(
                    buttonText:
                        _currentCarouselIndex < formatedVehicleList.length - 1
                            ? 'submit_and_next'.tr
                            : 'submit'.tr,
                    ...
                    onPressed: () {
                      ...
                      if (rating == 0) {
                        showCustomSnackBar('please_select_your_rating'.tr,
                            getXSnackBar: true);
                      } else if (comment.isEmpty) {
                        showCustomSnackBar('please_write_your_comment'.tr,
                            getXSnackBar: true);
                      } else {
  ...
  void submitOrSkip(
      TaxiOrderController taxiOrderController, int rating, String comment) {
    taxiOrderController
        .addVehicleReview(
      tripId: formatedVehicleList[_currentCarouselIndex].tripId!,
      vehicleId: formatedVehicleList[_currentCarouselIndex].vehicleId!,
      vehicleIdentityId:
          formatedVehicleList[_currentCarouselIndex].vehicleIdentityId!,
      rating: rating,
      comment: comment,
    )
        .then((success) {
      if (success) {
        taxiOrderController
            .getTripDetails(formatedVehicleList[_currentCarouselIndex].tripId!);
