  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
          right: fromCouponScreen! ? 0 : Dimensions.paddingSizeDefault,
          bottom: fromCouponScreen! ? Dimensions.paddingSizeSmall : 0),
      child: Stack(children: [
        Container(
          height: 80,
          width: fromCouponScreen! ? double.infinity : 250,
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(16),
            boxShadow: fromCouponScreen!
                ? [
                    BoxShadow(
            ...
            children: [
              Transform.rotate(
                ...
                child: CustomAssetImageWidget(
                    fromCouponScreen!
                        ? Images.taxiCouponSvg2
                        : Images.taxiCouponSvg,
                ...
                onTap: () {
                  if (fromBottomSheet!) {
                    ...
                    showCustomSnackBar('coupon_code_copied'.tr,
                        isError: false, getXSnackBar: fromBottomSheet!);
                  }
                },
                child: Row(children: [
                  Expanded(
                  ...
                  Expanded(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Image.asset(Images.taxiCopyIcon,
                              height: 25, width: 25),
                        ),
                      )),
                ]),
