...
class _TaxiCheckoutScreenState extends State<TaxiCheckoutScreen> {
  ...
  TextEditingController guestNameTextEditingController =
      TextEditingController();
  TextEditingController guestNumberTextEditingController =
      TextEditingController();
    ...
    return Scaffold(
      ...
      body: GetBuilder<TaxiCartController>(builder: (taxiCartController) {
        return GetBuilder<TaxiLocationController>(
          ...
          String schedule =
              taxiCartController.carCartModel!.userData!.pickupTime!;
          ...
          double tripCost = TaxiPriceHelper.calculateTripCost(
              taxiCartController.cartList,
              taxiCartController.carCartModel!.userData!);

          double productDiscountPrice = TaxiPriceHelper.calculateDiscountCost(
              taxiCartController.cartList,
              taxiCartController.carCartModel!.userData!,
              tripCost: tripCost,
              calculateProviderDiscount: false);
          double providerDiscountPrice = TaxiPriceHelper.calculateDiscountCost(
              taxiCartController.cartList,
              taxiCartController.carCartModel!.userData!,
              tripCost: tripCost,
              calculateProviderDiscount: true);
          double extraDiscount = TaxiPriceHelper.getExtraDiscountPrice(
              providerDiscountPrice, productDiscountPrice);
          double tripDiscount = TaxiPriceHelper.getDiscountPrice(
              providerDiscountPrice, productDiscountPrice, tripCost);
          ...
          double total = subtotal +
              ((taxiCartController.taxIncluded == 1)
                  ? 0
                  : taxiCartController.tripTax!) +
              serviceFee;
                ...
                child: Column(children: [
                    ...
                    child: Column(children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return CheckoutVehicleCard(
                              cart: taxiCartController.cartList[index]);
                        },
                      ),
                    ]),
                  ),
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: Padding(
                                    ...
                                    child: !taxiCartController.isCouponLoading
                                        ? taxiCartController.couponDiscount <= 0
                                            ? ElevatedButton(
                                                onPressed: () {
                                                  taxiCartController
                                                      .applyTaxiCoupon(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: CustomTextField(
                              ...
                              titleText:
                                  'ex_please_provide_good_conditioned_vehicle'
                                      .tr,
                              showLabelText: false,
                              maxLines: 3,
                  ...
                  Padding(
                    ...
                    child: BillDetailsWidget(
                      tripCost: tripCost,
                      tripDiscountCost: tripDiscount,
                      couponDiscountCost: couponDiscount,
                      subtotal: subtotal,
                      vat: taxiCartController.tripTax!,
                      serviceFee: serviceFee,
                      taxInclude: (taxiCartController.taxIncluded == 1),
                      taxPercent: taxiCartController.cartList[0].provider!.tax,
                    ),
                  ),
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Column(
                                ...
                                children: [
                                  Text(
                                    'by_placing_the_booking_you_are_agreed_to_the'
                                        .tr,
                                    style: robotoRegular.copyWith(
            ...
            Container(
              ...
              child: Column(children: [
                Row(
                    ...
                    children: [
                      Text(
                        '${rentalType == AppConstants.dayWise ? 'duration'.tr : 'estimated'.tr} ${rentalType == AppConstants.distanceWise ? taxiCartController.carCartModel?.userData?.distance?.toStringAsFixed(3) ?? 0 : rentalType == AppConstants.dayWise ? estimatedDay.toStringAsFixed(0) : taxiCartController.carCartModel?.userData?.estimatedHours ?? 0}'
                ...
                SafeArea(
                  child: CustomButton(
                    ...
                    onPressed: () async {
                      String numberWithCountryCode = countryDialCode! +
                      ...
                      if (AuthHelper.isGuestLoggedIn() &&
                        ...
                        DateTime selectedTime =
                            DateConverter.dateTimeStringToDate(schedule);
                        String scheduleTime =
                            DateConverter.formatDate(selectedTime);

                        if (!DateConverter.isAfterCurrentDateTime(
                            selectedTime)) {
                          selectedTime = DateTime.now();
                          scheduleTime =
                        ...
                        bool isScheduled =
                            !DateConverter.isSameDate(selectedTime);
                        ...
                        taxiCartController.tripBook(
                          ...
                          guestName: guestNameTextEditingController.text,
                          guestPhone: numberWithCountryCode,
                          guestEmail: guestEmailController.text,
                          couponCode: taxiCartController.couponCode,
                          scheduleTime: scheduleTime,
                          isSchedule: isScheduled,
                        );
                      }
