...
class _SearchVehicleScreenState extends State<SearchVehicleScreen> {
  ...
  final CustomDebounceWidget customDebounceWidget =
      CustomDebounceWidget(milliseconds: 500);
  ...
  Future<void> _searchSuggestions(String query) async {
    ...
    if (query == '') {
      ...
      _vehicles =
          await Get.find<TaxiHomeController>().getSearchSuggestions(query) ??
              [];
    }
    setState(() {});
  }
  ...
  void initState() {
    ...
    if (Get.find<TaxiHomeController>().popularCarSuggestionModelList != null &&
        Get.find<TaxiHomeController>().popularCarSuggestionModelList!.isEmpty) {
    ...
    return Container(
      ...
      child: GetBuilder<TaxiHomeController>(builder: (taxiHomeController) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          taxiHomeController.searchHistoryList.isNotEmpty
                        ...
                        onTap: () {
                          setState(() {
                            textSearchController.text =
                                taxiHomeController.searchHistoryList[index];
                          });
                        },
                        child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          if (taxiHomeController.popularCarSuggestionModelList != null &&
              taxiHomeController.popularCarSuggestionModelList!.isNotEmpty)
            SizedBox(
              width: double.infinity,
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('popular_search'.tr,
                    ...
                    Wrap(
                      ...
                      children: List.generate(
                          taxiHomeController
                              .popularCarSuggestionModelList!.length,
                          (index) => CustomInkWell(
                                onTap: () {
                                  setState(() {
                                    textSearchController.text =
                                        taxiHomeController
                                            .popularCarSuggestionModelList![
                                                index]
                                            .name!;
                                  });
                                },
