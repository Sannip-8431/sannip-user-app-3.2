...
class TripStatusView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
        spacing: tripDetailsModel.tripStatus == TripStatusEnum.canceled.name
            ? 0
            : Dimensions.paddingSizeLarge,
        children: [
          const SizedBox(),
          tripDetailsModel.tripStatus == TripStatusEnum.pending.name ||
                  tripDetailsModel.tripStatus ==
                      TripStatusEnum.confirmed.name ||
                  tripDetailsModel.tripStatus == TripStatusEnum.ongoing.name
              ? Image.asset(Images.taxiPending, height: 80)
              : const SizedBox(),
          tripDetailsModel.tripStatus == TripStatusEnum.pending.name
              ? RichText(
                  ...
                  text: TextSpan(children: <TextSpan>[
                    ...
                    TextSpan(
                        text: 'please_wait_for_vendor_confirmation'.tr,
                        style: robotoMedium.copyWith(
                            fontSize: Dimensions.fontSizeDefault,
                            color: Theme.of(context).disabledColor))
                  ]))
              : tripDetailsModel.tripStatus == TripStatusEnum.confirmed.name
                  ? RichText(
                      textAlign: TextAlign.center,
                      text: TextSpan(children: <TextSpan>[
                        TextSpan(
                        ...
                        TextSpan(
                            text:
                                'driver_will_arrive_soon_to_the_pickup_location'
                                    .tr,
                            style: robotoMedium.copyWith(
                                fontSize: Dimensions.fontSizeDefault,
                                color: Theme.of(context).disabledColor))
                  ...
                  : tripDetailsModel.tripStatus == TripStatusEnum.ongoing.name
                      ? Column(spacing: Dimensions.paddingSizeSmall, children: [
                          RichText(
                              ...
                              text: TextSpan(children: <TextSpan>[
                                ...
                                TextSpan(
                                    text:
                                        'you_will_be_reached_your_destination_approximately'
                                            .tr,
                                    style: robotoMedium.copyWith(
                                        fontSize: Dimensions.fontSizeDefault,
                                        color: Theme.of(context).disabledColor))
                          ...
                          Text(
                            tripDetailsModel.tripType == 'hourly'
                                ? DateConverter.durationFromNow(tripDetailsModel
                                            .estimatedTripEndTime!) <
                                        20
                                    ? DateConverter.durationFromNow(
                                                tripDetailsModel
                                                    .estimatedTripEndTime!) >
                                            0
                                    ...
                                    : DateConverter.dateTimeStringToDateTime(
                                        tripDetailsModel.estimatedTripEndTime!)
                                : DateConverter.dateTimeStringToDateTime(
                                    tripDetailsModel.estimatedTripEndTime!),
                      ...
                      : (tripDetailsModel.tripStatus ==
                              ...
                              tripDetailsModel.tripType == 'hourly'
                                  ? Row(
                                      ...
                                      children: [
                                          ...
                                          Text(
                                              ' - ${tripDetailsModel.estimatedHours}',
                                              style: robotoBold.copyWith(
                                                  fontSize:
                                                      Dimensions.fontSizeSmall,
                                                  color: Colors.black))
                                        ])
                                  : tripDetailsModel.tripType == 'day_wise'
                                      ? Row(
                                          mainAxisAlignment:
                                              MainAxisAlignment.center,
                                          children: [
                                                  ...
                                                  style: robotoRegular.copyWith(
                                                      ...
                                                      color: Theme.of(context)
                                                          ...
                                                          .withValues(
                                                              alpha: 0.6))),
                                              Text(
                                                  ' - ${((tripDetailsModel.estimatedHours ?? 0) / 24).toStringAsFixed(0)} ${'day'.tr}',
                                                  style: robotoBold.copyWith(
                                                      fontSize: Dimensions
                                                          .fontSizeSmall,
                                                      color: Colors.black))
                                              ...
                                              Text('total_distance'.tr,
                                                  style: robotoRegular.copyWith(
                                                      ...
                                                      color: Colors
                                                          .grey.shade600)),
                                              Text(
                                                  ' - ${tripDetailsModel.distance?.toStringAsFixed(2)} ${'km'.tr}',
                                                  style: robotoBold.copyWith(
                                                      fontSize: Dimensions
                                                          .fontSizeSmall,
                                                      color: Colors.black))
                          ...
                          : tripDetailsModel.tripStatus ==
                                  ...
                                  tripDetailsModel.paymentStatus == 'paid'
                              ? Column(children: [
                                  Image.asset(Images.taxiCompletedGif,
                                      height: 150),
                                  const SizedBox(
