...
class _SelectedVehiclesViewState extends State<SelectedVehiclesView> {
    ...
    return Container(
      ...
      child: Column(spacing: Dimensions.paddingSizeSmall, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          widget.tripDetailsList.length > 2
              ? CustomInkWell(
                  onTap: () {
                    setState(() {
        ...
        if (showCarList || widget.tripDetailsList.length <= 2)
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return TripVehicleCard(
                  tripDetails: widget.tripDetailsList[index]);
            },
          ),
      ]),
    );
  ...
  Widget showMultipleView(
      BuildContext context, List<TripDetails> tripDetailsList) {
    return Row(children: [
      Stack(clipBehavior: Clip.none, children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: Colors.grey.shade50.withValues(alpha: 1),
                  blurRadius: 1,
          ...
          child: ClipRRect(
            ...
            child: CustomImage(
                image:
                    tripDetailsList[0].vehicleDetails!.thumbnailFullUrl ?? ''),
          ),
        ),
        Positioned(
          left: 40,
          ...
          child: Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              child: CustomImage(
                  image: tripDetailsList[1].vehicleDetails!.thumbnailFullUrl ??
                      ''),
            ),
          ),
        ),
            ...
            child: Stack(
              children: [
                ClipRRect(
                  ...
                  child: CustomImage(
                    image:
                        tripDetailsList[2].vehicleDetails!.thumbnailFullUrl ??
                            '',
                    fit: BoxFit.cover,
                    height: 75,
                    width: 80,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(children: [
        Row(children: [
          Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              child: CustomImage(
                  image: widget.tripDetails.vehicleDetails!.thumbnailFullUrl ??
                      ''),
            ),
          ),
          ...
          Expanded(
            child:
              ...
              Padding(
                ...
                child: Text(
                  '${widget.tripDetails.vehicleDetails!.name}',
                  style:
              ...
              RichText(
                ...
                TextSpan(
                    text: '${widget.tripDetails.quantity}',
                    style: robotoBold.copyWith(
                        fontSize: Dimensions.fontSizeDefault,
                        color: Theme.of(context).disabledColor))
              ]))
        ...
        if (widget.tripDetails.licensePlateNumber != null &&
            widget.tripDetails.licensePlateNumber!.isNotEmpty)
          Container(
            decoration: BoxDecoration(
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: Wrap(
                      ...
                      children:
                          widget.tripDetails.licensePlateNumber!.map((number) {
                        return Text(
