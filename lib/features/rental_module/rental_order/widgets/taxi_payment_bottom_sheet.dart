...
class TaxiPaymentBottomSheet extends StatefulWidget {
  ...
  const TaxiPaymentBottomSheet(
      {super.key, required this.totalPrice, required this.id});
...
class _TaxiPaymentBottomSheetState extends State<TaxiPaymentBottomSheet> {
  ...
  Widget build(BuildContext context) {
    return Container(
      constraints: BoxConstraints(
          maxHeight: MediaQuery.of(context).size.height * 0.85, minHeight: 100),
      child: GetBuilder<TaxiOrderController>(builder: (taxiOrderController) {
                        ...
                        Container(
                          ...
                          child: CustomInkWell(
                            ...
                            child: Row(
                                ...
                                children: [
                                  Text('cash_payment'.tr,
                                      style: robotoBold.copyWith(fontSize: 14)),
                                  Icon(
                                    taxiOrderController.paymentMethodIndex == 1
                                        ? Icons.radio_button_checked
                                        : Icons.radio_button_off,
                                    size: 24,
                                    color: taxiOrderController
                                                .paymentMethodIndex ==
                                            1
                              ...
                              children: [
                                ...
                                ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      bool isSelected = taxiOrderController
                                                  .paymentMethodIndex ==
                                              2 &&
          ...
          Padding(
            ...
            child: SafeArea(
              child: CustomButton(
                ...
                onPressed: taxiOrderController.paymentMethodIndex == -1 ||
                        (taxiOrderController.isPartialPay &&
                            taxiOrderController.paymentMethodIndex == 0)
                    ? null
                    : () {
                        taxiOrderController
                            .makePayment(
                          id: widget.id,
                          paymentMethod: taxiOrderController
                                          .paymentMethodIndex ==
                                      0 &&
                                  !taxiOrderController.isPartialPay
                              ? 'wallet'
  ...
  Widget walletView(TaxiOrderController taxiOrderController) {
    ...
    bool isWalletSelected = taxiOrderController.paymentMethodIndex == 0 ||
        taxiOrderController.isPartialPay;
    return Column(children: [
      Container(
        padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
      ...
      if (isWalletSelected && taxiOrderController.isPartialPay)
        Column(children: [
          ...
          if (taxiOrderController.paymentMethodIndex == 0)
            Text('* ${'please_select_how_to_pay_remain_billing_amount'.tr}',
