        ...
        Padding(
          ...
          child: TripFromToCard(
            fromAddress: AddressModel(
                address: tripDetailsModel.pickupLocation?.locationName,
                addressType: tripDetailsModel.pickupLocation?.locationType),
            toAddress: AddressModel(
                address: tripDetailsModel.destinationLocation?.locationName,
                addressType:
                    tripDetailsModel.destinationLocation?.locationType),
          ),
        ),
                    ...
                    children: [
                      ...
                      Text(
                        tripDetailsModel.tripType == 'hourly'
                            ? '${tripDetailsModel.tripType!.tr} (${tripDetailsModel.estimatedHours} ${'hrs'.tr})'
                            : tripDetailsModel.tripType!.tr,
                        style: robotoRegular.copyWith(
                            fontSize: Dimensions.fontSizeSmall,
                            color: Theme.of(context).disabledColor),
                      ),
