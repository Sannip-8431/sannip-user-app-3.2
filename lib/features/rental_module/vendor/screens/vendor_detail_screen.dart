...
class _VendorDetailScreenState extends State<VendorDetailScreen> {
  ...
  void initState() {
    ...
    Get.find<TaxiVendorController>()
        .initFilterSetup(maxPrice: 0, willUpdate: false);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('provider_details'.tr,
      ...
      body: GetBuilder<TaxiVendorController>(builder: (vendorController) {
        ...
        return CustomScrollView(slivers: [
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Stack(children: [
                              ...
                              vendorController.isProviderOpenNow(
                                      vendor.status == 1, vendor.schedules)
                                  ? const SizedBox()
                                  : Positioned(
                                      bottom: 0,
                                      left: 0,
                        ...
                        Expanded(
                          child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    '${'approx_pickup_time'.tr}: ${vendor.deliveryTime ?? ''}',
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    style: robotoRegular.copyWith(
                                        fontSize:
                        ...
                        children: [
                          Column(
                              ...
                              children: [
                                ...
                                TaxiRatingBar(
                                    rating: vendor.avgRating?.toDouble(),
                ...
                vendor.announcement == 1
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: Colors.orange, width: 0.1)),
                        child: Row(children: [
                          Image.asset(Images.announcement,
                              height: 20, width: 20, color: Colors.orange),
                          const SizedBox(width: 10),
                          Expanded(
                              child: Text(vendor.announcementMessage ?? '',
                                  style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall),
                                  softWrap: true)),
                        ]),
                ...
                vendor.discount != null
                    ? Container(
                        ...
                        margin: const EdgeInsets.symmetric(
                            ...
                            horizontal: Dimensions.paddingSizeLarge),
                        child: Text(
                          '${vendor.discount!.discountType == 'percent' ? '${vendor.discount!.discount}% ' : '${PriceConverter.convertPrice(vendor.discount!.discount)} ${'off'.tr}'} '
                        ...
                        child: Row(
                            ...
                            children: [
                              RichText(
                                ...
                                TextSpan(
                                    text:
                                        '${vendorController.taxiVendorVehicleList?.totalSize ?? 0} ',
                                    style: robotoRegular.copyWith(
                                        fontSize: Dimensions.fontSizeSmall,
                                        color: Theme.of(context)
                                            .textTheme
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  await vendorController.getVendorVehicleList(
                                      offset: 1,
                                      vendorId: widget.vendorId!,
          ...
          SliverToBoxAdapter(
            child: vendorController.taxiVendorVehicleList != null
                ? vendorController.taxiVendorVehicleList!.vehicles!.isNotEmpty
                    ? PaginatedListView(
                        scrollController: _scrollController,
                        onPaginate: (int? offset) async =>
                            vendorController.getVendorVehicleList(
                                offset: offset!, vendorId: widget.vendorId!),
                        totalSize:
                            vendorController.taxiVendorVehicleList?.totalSize,
                        offset: vendorController.taxiVendorVehicleList?.offset,
                        itemView: ListView.builder(
                          scrollDirection: Axis.vertical,
                          itemCount: vendorController
                              .taxiVendorVehicleList!.vehicles!.length,
                          padding: const EdgeInsets.only(bottom: 50),
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            return VendorVehicleCard(
                                vehicle: vendorController
                                    .taxiVendorVehicleList!.vehicles![index]);
                          },
                        ),
                      )
                    : NoDataScreen(text: 'no_vehicle_available'.tr)
                : const Center(
                    child: Padding(
