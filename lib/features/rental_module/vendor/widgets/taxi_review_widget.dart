...
class TaxiReviewWidget extends StatelessWidget {
  ...
  const TaxiReviewWidget(
      {super.key, this.review, required this.hasDivider, this.storeName});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SizedBox(
            height: review!.reply != null ? Dimensions.paddingSizeSmall : 0),
        review!.reply != null
            ? Container(
                padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                margin: const EdgeInsets.only(
                    left: 50, bottom: Dimensions.paddingSizeSmall),
                decoration: BoxDecoration(
                    borderRadius:
