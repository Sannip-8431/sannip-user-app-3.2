...
class TaxiProviderReviewListWidget extends StatelessWidget {
  ...
  const TaxiProviderReviewListWidget(
      {super.key, required this.taxiVendorController, this.providerName});

  @override
  Widget build(BuildContext context) {
    return taxiVendorController.providerReviewList != null
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return TaxiReviewWidget(
                hasDivider: index !=
                    taxiVendorController.providerReviewList!.length - 1,
