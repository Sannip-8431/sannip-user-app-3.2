...
class SearchAndFilterWidget extends StatefulWidget {
  ...
  const SearchAndFilterWidget(
      {super.key,
      required this.taxiVendorController,
      this.vendorId,
          ...
          child:
            ...
            Row(children: [
              Container(
                ...
                child: CustomInkWell(
                  onTap:
                      widget.taxiVendorController.taxiVendorVehicleList == null
                          ? null
                          : () {
                ...
                child: CustomInkWell(
                  onTap:
                      widget.taxiVendorController.taxiVendorVehicleList == null
                          ? null
                          : () {
                              double? maxPrice = widget.taxiVendorController
                                      .taxiVendorVehicleList?.maxPrice ??
                                  1000;
                              Get.bottomSheet(
                                VehicleFilterWidget(
                                  searchCarName: widget.searchName ?? '',
                                  vendorId: widget.vendorId,
                                  minPrice: widget.taxiVendorController
                                          .taxiVendorVehicleList?.minPrice ??
                                      0,
                                  maxPrice: maxPrice,
                                ),
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String name = StringLimitHelper.limitText(
                    widget.taxiVendorController.categories?[index].name ?? '',
                    20);
                return Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                  ...
                  margin: const EdgeInsets.only(
                      right: Dimensions.paddingSizeSmall, top: 3, bottom: 3),
                  child: CustomInkWell(
                    onTap: () {
                      setState(() {
                        selectedIndex = index;
                      });
                      widget.taxiVendorController.setCategoryId(
                          widget.taxiVendorController.categories?[index].id);
                      widget.taxiVendorController.getVendorVehicleList(
                          offset: 1, vendorId: widget.vendorId!);
                    },
