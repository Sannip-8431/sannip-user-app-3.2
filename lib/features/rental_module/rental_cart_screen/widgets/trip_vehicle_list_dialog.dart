        ...
        child: GetBuilder<TaxiCartController>(builder: (taxiCartController) {
          return Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(
              ...
              child: Row(children: [
                Expanded(
                    child: Text('trip_vehicle_list'.tr,
            ...
            Column(mainAxisSize: MainAxisSize.min, children: [
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  VehicleModel vehicle =
                      taxiCartController.cartList[index].vehicle!;
                  bool isExist = false;
                  ...
                  return Column(children: [
                    Row(children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${vehicle.tripHourly! ? 'hourly'.tr : ''}, ${vehicle.tripDayWise! ? 'day_wise'.tr : ''} ${vehicle.tripDistance! ? ', ${'distance_wise'.tr}' : ''}',
                      ...
                      Container(
                        ...
                        child: Icon(
                          isExist ? Icons.check : Icons.warning_amber_rounded,
                          color: Colors.white,
                          size: 16,
                        ),
                      )
              ...
              Padding(
                ...
                child: Wrap(children: [
                  Text(
                    'one_or_more_of_the_selected_vehicles_does_not_match_the_chosen_rental_type'
                        .tr,
                    style: robotoRegular.copyWith(
                        fontSize: Dimensions.fontSizeSmall),
                  )
                    ...
                    ? Row(children: [
                        ...
                        Expanded(
                          ...
                          child: CustomButton(
                            ...
                            onPressed: () async {
                              List<int> ids = await getUnavailableVehiclesId(
                                  taxiCartController.cartList);
                              taxiCartController
                                  .clearMultipleCart(ids)
                                  .then((success) {
                                if (success) {
                                  // Get.back();
                                  taxiCartController
                                    ...
                                    if (success) {
                                      if (newVehicle != null &&
                                          cartIndex == null) {
                                        await taxiCartController
                                            .addToCart(newVehicle!);
                                      } else if (cartIndex != null) {
                                        taxiCartController.setQuantity(
                                            isIncrement!, cartIndex!);
                                      }
