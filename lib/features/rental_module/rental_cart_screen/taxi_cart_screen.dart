    ...
    return Scaffold(
      ...
      body: GetBuilder<TaxiCartController>(builder: (taxiCartController) {
        ...
        if (taxiCartController.cartList.isNotEmpty &&
            taxiCartController.carCartModel != null &&
            taxiCartController.carCartModel!.userData != null) {
          totalPrice = TaxiPriceHelper.calculateTripCost(
          ...
          extraDiscount = TaxiPriceHelper.getExtraDiscountPrice(
              providerDiscountPrice, productDiscountPrice);
          discountPrice = TaxiPriceHelper.getDiscountPrice(
              providerDiscountPrice, productDiscountPrice, totalPrice);
        }
        totalPrice = totalPrice - discountPrice;

        return taxiCartController.cartList.isNotEmpty
            ? Column(children: [
                Expanded(
                        ...
                        children: [
                          ...
                          TripFromToCard(
                            fromAddress: AddressModel(
                                address: taxiCartController
                                        .carCartModel
                                        ?.userData
                                        ?.pickupLocation
                                        ?.locationName ??
                                    '',
                                addressType: taxiCartController.carCartModel
                                    ?.userData?.pickupLocation?.locationType),
                            toAddress: AddressModel(
                                address: taxiCartController
                                        ...
                                        ?.locationName ??
                                    '',
                                addressType: taxiCartController
                                    .carCartModel
                                    ?.userData
                                    ?.destinationLocation
                                    ?.locationType),
                              ...
                              Get.to(() => TaxiLocationScreen(
                                    fromAddress: AddressModel(
                                      ...
                                      address: taxiCartController
                                          ...
                                          .pickupLocation!
                                          .locationName,
                                      latitude: taxiCartController.carCartModel!
                                          .userData!.pickupLocation!.lat,
                                      longitude: taxiCartController
                                          .carCartModel!
                                          .userData!
                                          .pickupLocation!
                                          .lng,
                                    ...
                                    toAddress: AddressModel(
                                      ...
                                      address: taxiCartController
                                          ...
                                          .locationName,
                                      latitude: taxiCartController.carCartModel!
                                          .userData!.destinationLocation!.lat,
                                      longitude: taxiCartController
                                          .carCartModel!
                                          .userData!
                                          .destinationLocation!
                                    ...
                                    userData: taxiCartController
                                        .carCartModel!.userData,
                                  ));
                            },
                          ),
                          ...
                          Align(
                            ...
                            child: Text('selected_vehicle'.tr,
                                style: robotoBold.copyWith(
                                    fontSize: Dimensions.fontSizeDefault)),
                          ),
                          const SizedBox(height: Dimensions.paddingSizeLarge),

                          taxiCartController.cartList.isNotEmpty
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return VehicleCard(
                                      vehicle: taxiCartController
                                          .cartList[index].vehicle!,
                                      index: index,
                                      carts: taxiCartController.cartList[index],
                                      isCartHourly: taxiCartController
                                              .carCartModel
                                              ?.userData
                                              ?.rentalType ==
                                          'hourly',
                                      fromSelectVehicleScreen:
                                          widget.fromSelectVehicleScreen,
                                    );
                                  },
                                )
                              ...
                              onTap: () {
                                if (taxiCartController.cartList.isNotEmpty) {
                                  Get.to(() => VendorDetailScreen(
                                      vendorId: taxiCartController
                                          .cartList[0].vehicle!.providerId));
                                } else {
                                  Get.back();
                                }
                              },
                              child: Text('add_more_vehicle'.tr,
                                  style: robotoBold.copyWith(
                                      fontSize: 14,
            ...
            : Center(
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  const CustomAssetImageWidget(Images.taxiEmptyCart,
                      height: 80),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
