...
class CartHelper {
  static Future<bool> checkTypeInCart(
      List<Carts> cartList, String rentalType) async {
    bool status = false;
  ...
  static String calculateHour(
      {required String tripType, required String time, required String day}) {
    if (time.isEmpty) {
      time = '0';
    }
    if (day.isEmpty) {
