...
class TaxiLocationResultBottomSheet extends StatefulWidget {
  ...
  const TaxiLocationResultBottomSheet(
      {super.key, this.vehicle, this.searchName});

  @override
  State<TaxiLocationResultBottomSheet> createState() =>
      _TaxiLocationResultBottomSheetState();
}

class _TaxiLocationResultBottomSheetState
    extends State<TaxiLocationResultBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.vehicle != null) {
      ...
      if (widget.vehicle!.provider != null &&
          widget.vehicle!.provider!.discount != null) {
        discount = widget.vehicle!.provider!.discount!.discount ?? 0;
        discountType =
            widget.vehicle!.provider!.discount!.discountType ?? 'percent';
      }
    }
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Row(children: [
                              ...
                              showTripTypeDay
                                  ? TripTypeCard(
                                      tripType: 'day_wise',
                                      amount: PriceConverter.convertPrice(0),
                    ...
                    ? CustomButton(
                        ...
                        onPressed: () async {
                          if (taxiLocationController.finalTripDateTime ==
                            ...
                            Get.find<TaxiHomeController>().getSelectedCars(
                                offset: 1,
