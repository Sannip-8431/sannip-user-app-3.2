...
class TaxiLocationResultScreen extends StatefulWidget {
  ...
  @override
  State<TaxiLocationResultScreen> createState() =>
      _TaxiLocationResultScreenState();
}
...
class _TaxiLocationResultScreenState extends State<TaxiLocationResultScreen> {
  ...
  void initState() {
    ...
    Get.find<TaxiLocationController>()
        .selectTripType(tripType, willUpdate: false);
    Get.find<TaxiLocationController>()
        .setTripDate(DateTime.now(), willUpdate: false);
    Get.find<TaxiLocationController>()
        .setTripTime(DateTime.now(), willUpdate: false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
          GetBuilder<TaxiLocationController>(builder: (taxiLocationController) {
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: SizedBox(
                      ...
                      child: Image.memory(taxiLocationController.mapScreenshot!,
                          scale: 1.0, fit: BoxFit.fitWidth),
                    ),
                  ),
                ),
                Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                              ...
                              children: [
                                ...
                                CustomInkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Image.asset(Images.taxiEditIcon,
                                        height: 20, width: 20),
                                  ),
                                ),
                              ]),
                        ...
                        TripFromToCard(
                            ...
                            toAddress: taxiLocationController.toAddress!),
                        const SizedBox(height: Dimensions.paddingSizeDefault),

                        Padding(
                          padding: const EdgeInsets.symmetric(
                              vertical: Dimensions.paddingSizeSmall),
                          child: Text("pickup_time".tr,
                              style: robotoBold.copyWith(
                                  fontSize: Dimensions.fontSizeLarge)),
                        ),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        PickupTimeCard(
                            taxiLocationController: taxiLocationController),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        SizedBox(
                          ...
                          child: SingleChildScrollView(
                            ...
                            padding: const EdgeInsets.symmetric(
                                vertical: Dimensions.paddingSizeSmall),
                            child: Row(children: [
                              showTripTypeDistance
                                  ? TripTypeCard(
                                      tripType: 'distance_wise',
                                      amount: PriceConverter.convertPrice(
                                          widget.vehicle?.distancePrice ?? 0),
                                      discountAmount: widget.vehicle != null
                                          ? PriceConverter.convertPrice(
                                              widget.vehicle!.distancePrice! -
                                                  distanceWiseDiscount)
                                          : '',
                                      fareType: 'km',
                                      indicatorIcon: Icons.radio_button_off,
                                      isVehicleDetailScene: false,
                                      isClockIcon: false,
                                      haveVehicle: widget.vehicle != null,
                                      distanceMinPrice:
                              ...
                              showTripTypeHourly
                                  ? TripTypeCard(
                                      ...
                                      isClockIcon: false,
                                      haveVehicle: widget.vehicle != null,
                                      hourMinPrice: Get.find<SplashController>()
                                              .configModel!
                                  ...
                                  : const SizedBox(),
                              SizedBox(
                                  width: showTripTypeDistance || showTripTypeDay
                                      ? Dimensions.paddingSizeDefault
                                      : 0),
                              showTripTypeDay
                                  ? TripTypeCard(
                        ...
                        taxiLocationController.tripType == 'hourly'
                            ? CustomTextField(
                                controller: taxiLocationController
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: taxiLocationController.tripType == 'hourly'
                                ? Dimensions.paddingSizeExtraLarge
                                : 0),

                        taxiLocationController.tripType == 'day_wise'
                            ? CustomTextField(
                                controller: taxiLocationController
          ...
          Container(
            ...
            child: SafeArea(
              child:
                ...
                return !taxiCartController.isLoading
                    ? CustomButton(
                        buttonText: widget.vehicle != null
                            ? 'add_to_cart'.tr
                            : 'confirm_and_search_vehicle'.tr,
                        onPressed: () async {
                          if (taxiLocationController.finalTripDateTime ==
                              null) {
                            showCustomSnackBar('please_select_pickup_time'.tr);
                          } else if (taxiLocationController.tripType ==
                                  'hourly' &&
                              taxiLocationController
                                  .estimateTimeController.text.isEmpty) {
                            ...
                            showCustomSnackBar(
                                'please_enter_valid_estimate_time'.tr);
                          } else if (taxiLocationController.tripType ==
                                  'day_wise' &&
                              taxiLocationController
                                  .estimateDayController.text.isEmpty) {
                            ...
                            showCustomSnackBar(
                                'please_enter_valid_estimate_days'.tr);
                          } else {
                            if (widget.vehicle != null) {
                              _addToCart(taxiLocationController,
                                  taxiCartController, widget.vehicle!);
                            } else {
                              Get.to(() => SelectVehicleScreen(
                                  fromAddress:
                                      taxiLocationController.fromAddress,
                                  toAddress: taxiLocationController.toAddress));
                            }
                          }
                        })
  ...
  Future<void> _addToCart(TaxiLocationController locationController,
      TaxiCartController taxiCartController, VehicleModel vehicle) async {
    ...
    CarCart cart = CarCart(
      ...
      estimatedHour: locationController.tripType == 'day_wise'
          ? estimatedDay.toStringAsFixed(0)
          : locationController.estimateTimeController.text,
