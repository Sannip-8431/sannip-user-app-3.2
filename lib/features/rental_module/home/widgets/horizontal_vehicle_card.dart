    ...
    return Container(
        ...
        child: CustomInkWell(
          onTap: () => Get.to(() => VehicleDetailsScreen(
                vehicleId: widget.vehicleModel.id,
              )),
            ...
            Stack(children: [
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: CustomImage(
                      image: widget.vehicleModel.thumbnailFullUrl ?? ''),
                ),
              ),
              Positioned(
                left: 0,
              ...
              Positioned(
                bottom: 5,
                right: 5,
                child: widget.vehicleModel.vehicleIdentitiesCount! > 1
                    ? Row(children: [
                        AnimatedContainer(
              ...
              CustomInkWell(
                onTap: () {
                  Get.to(() => VendorDetailScreen(
                      vendorId: widget.vehicleModel.providerId));
                },
                child: Padding(
            ...
            Align(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                    ...
                    children: [
                      widget.vehicleModel.avgRating! > 0
                          ? FeatureItem(
                              image: Images.taxiStarIcon,
                              text:
                                  '${widget.vehicleModel.avgRating?.toStringAsFixed(1)}',
                              iconColor: Colors.amber)
                          : const SizedBox(),
                      SizedBox(
                          width: widget.vehicleModel.avgRating! > 0 ? 16 : 0),
                      FeatureItem(
                          image: Images.taxiACIcon,
                          text: widget.vehicleModel.airCondition!
                              ? 'ac'.tr
                              : 'non_ac'.tr,
                      ...
                      FeatureItem(
                          ...
                          text: '${widget.vehicleModel.type?.toTitleCase()}',
                          iconColor: Colors.grey),
                      const SizedBox(width: 16),
                      FeatureItem(
                          image: Images.taxiSeatIcon,
                          text:
                              '${widget.vehicleModel.seatingCapacity} ${"seats".tr}',
                          iconColor: Colors.grey),
                    ]),
              ),
            ),
