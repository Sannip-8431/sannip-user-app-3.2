                      ...
                      Expanded(
                        child: Column(
                            ...
                            children: [
                              CustomTextField(
                                hintText:
                                    'taxpayer_identification_number_tin'.tr,
                                labelText: 'tin'.tr,
                                ...
                                validator: (value) =>
                                    ValidateCheck.validateEmptyText(value,
                                        "vendor_tin_field_is_required".tr),
                              ),
                              const SizedBox(
                  ...
                  if (storeRegController.storeStatus == 0.1 ||
                    ...
                    if (storeRegController.storeStatus == 0.1 &&
                      ...
                      if (_formKeyFirst!.currentState!.validate()) {
                        ...
                        } else if (storeRegController.tinExpireDate == null ||
                            storeRegController.tinExpireDate!.isEmpty) {
                          showCustomSnackBar('select_tin_expire_date'.tr);
                        } else if (storeRegController.tinFiles == null ||
                            storeRegController.tinFiles!.isEmpty) {
